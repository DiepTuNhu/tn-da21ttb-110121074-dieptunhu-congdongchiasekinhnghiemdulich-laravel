      ...
      <div class="row">
        <div class="col-12">
            ...
            <tr>   
                ...
                <td>
                  {{-- <a class="btn btn-info" style="margin-bottom: 5px; width: 105px" href="{{ route('photos.create', ['id_destination' => $destination->id]) }}">Thêm ảnh</a>
                  <a class="btn btn-success" style="margin-bottom: 5px; width: 105px" href="{{ route('photos.index', ['id' => $destination->id]) }}">Xem ảnh</a> --}}
